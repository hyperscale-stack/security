...
func (_m *MockStorage) LoadAccess(token string) (*AccessInfo, error) {
	ret := _m.Called(token)
...
func (_m *MockStorage) LoadAuthorize(code string) (*AuthorizeInfo, error) {
	ret := _m.Called(code)
...
func (_m *MockStorage) LoadClient(id string) (Client, error) {
	ret := _m.Called(id)
...
func (_m *MockStorage) LoadRefresh(token string) (*AccessInfo, error) {
	ret := _m.Called(token)
...
func (_m *MockStorage) RemoveAccess(token string) error {
	ret := _m.Called(token)
...
func (_m *MockStorage) RemoveAuthorize(code string) error {
	ret := _m.Called(code)
...
func (_m *MockStorage) RemoveClient(id string) error {
	ret := _m.Called(id)
...
func (_m *MockStorage) RemoveRefresh(token string) error {
	ret := _m.Called(token)
...
func (_m *MockStorage) SaveAccess(_a0 *AccessInfo) error {
	ret := _m.Called(_a0)
...
func (_m *MockStorage) SaveAuthorize(_a0 *AuthorizeInfo) error {
	ret := _m.Called(_a0)
...
func (_m *MockStorage) SaveClient(_a0 Client) error {
	ret := _m.Called(_a0)
...
func (_m *MockStorage) SaveRefresh(_a0 *AccessInfo) error {
	ret := _m.Called(_a0)
